...
class CategoryController extends Controller
{
 ...
 public function listAppCategories(Request $request){
    ...
    public function getById(Category $category)
    {
         $data = $category;
        return response()->json(['success' => true ,'data'=> $data,
        'message'=> 'Category retrieved successfully', 'description'=> 'Category Details', 'code'=>'200'],200);
    }
       ...
       public function create(Request $request){
        ...
        if(!$hasCreated->update($hasUploaded))
            return response()->json(['message' => 'Category has not created or image not uploaded,
             ...
             'message'=> 'Successfully Added!', 'description'=> 'Add Category', 'code'=>'200'],200);
      ...
      public function update(Request $request, $categoryId){
        ...
        if(!$category->update($validatedData))
            return response()->json(['message' => 'category has not updated, contact support please',
                'input' => $categoryId], 500);

            return response()->json(['success' => true ,'data'=> $category,
                'message'=> 'Successfully updated!', 'description'=> 'Update Category', 'code'=>'200'],200);
    ...
    public function delete($categoryId){
        ...
        if(!$category->delete())
            return response()->json(['message' => 'category has not deleted, contact support please',
                'input' => $categoryId], 500);
