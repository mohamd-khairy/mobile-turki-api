...
class CountryController extends Controller
{
    ...
    public function getAll()
    {
        ...
        return response()->json(['success' => true ,'data'=> $data,
             'message'=> 'Countries retrieved successfully', 'description'=> 'list Of Countries', 'code'=>'200'],200);
    ...
    { 
        $data = $country;
        return response()->json(['success' => true ,'data'=> $data,
        'message'=> 'Country retrieved successfully', 'description'=> ' Country Details', 'code'=>'200'],200);
    ...
    public function getActiveCountries()
    {
        ...
        return response()->json(['success' => true ,'data'=> $ActiveCountries,
        'message'=> 'Active Countries retrieved successfully', 'description'=> ' List Of Active Countries', 'code'=>'200'],200);
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($country) {
           ...
           return response()->json(['success' => true ,'data'=> $country,
             'message'=> 'Successfully Added!', 'description'=> 'Add Countries', 'code'=>'200'],200);
    ...
    public function updateStatus(Country $country)
    {
        $country->is_active = !$country->is_active;
            if ($country->update()) {
                ...
                return response()->json(['success' => true ,'data'=> $country,
                'message'=> 'Successfully updated!', 'description'=> 'Update Status Countries', 'code'=>'200'],200);
            }
        return response()->json(['message' => 'Something went wrong!'], 500);
