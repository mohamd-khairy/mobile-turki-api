...
//            }
    ...
    public function verfiyOTP(Request $request)
    {
        ...
        if ($customerOtpLog != null && $validated['mobile_verification_code'] == $customerOtpLog->mobile_verification_code) {
            ...
            return response()->json(['message' => 'Customer retrieved successfully',
                'data' => $customer, 'description' => '', 'code' => '200', 'success' => true], 200);
        } else if ($customerOtpLog != null) {

         if ($validated['mobile'] == '+966561051956' || $validated['mobile'] == '+966507452527' ||$validated['mobile'] == '+966571436900') {
                return response()->json(['message' => 'code mismatch!, please try again.',
                    'data' => null, 'description' => 'dev mode, your code is: '. $customerOtpLog->mobile_verification_code, 'code' => '400', 'success' => false], 400);
            }
            ...
            if ($customerOtpLog->no_attempts > 10 && $customerOtpLog->disabled == 0) {
                ...
                return response()->json(['message' => __("your account is disabled, you have  " . $customerOtpLog->no_attempts . " wrong attempts, try after 24 hours!"),
            ...
            if ($customerOtpLog->no_attempts <= 10 && $customerOtpLog->disabled == 0) {
                ...
                return response()->json(['message' => 'code mismatch!, please try again.',
                    'data' => null, 'description' => 'no_attempts: '.  $customerOtpLog->no_attempts, 'code' => '400', 'success' => false], 400);
            ...
            if ($customerOtpLog->disabled == 1 && $timeToRelease) {
                ...
                return response()->json(['message' => 'your account is active now, get new code!',
                    'data' => null, 'description' => '', 'code' => '400', 'success' => false], 400);
            }
        }

        return response()->json(['message' => 'get code first!',
                'data' => null, 'description' => '', 'code' => '400', 'success' => false], 400);
...
//
    ...
    public function logout(Request $request)
    {
        if (auth()->user()->token()->revoke()) {
            return response()->json(['message' => 'success',
                'data' => null, 'description' => '', 'code' => '200', 'success' => true], 200);
        }
        return response()->json(['message' => __('templates.httpCode.401')
            , 'description' => ''], 401);
    }
    ...
    public function passwordReset(Request $request)
    {
        ...
        if (!$user->is_active)
            return response()->json(['message' => __("templates.httpCode.401"),
                'description' => "Please contact support to activate your account!"], 401);
       ...
       public function getAddress(Request $request)
    {
        ...
        'message'=> 'Address retrieved successfully', 'description'=> 'list Of Products', 'code'=>'200'],200);
    }
    ...
    public function createAddressCustomer(Request $request)
    {
        ...
        if ($country === null)
            return response()->json(['data'=> [],
                'success' => false, 'message'=> 'failed', 'description'=>'country not found, contact support!', 'code'=>'400'],400);
        ...
        if ($currentCity === null)
            return response()->json(['data'=> [],
                'success' => false, 'message'=> 'failed', 'description'=>'city not found!', 'code'=>'400'],400);
      ...
      public function editAddressCustomer(Request $request, $address)
    {
        if($request->post() == null)
            return response()->json(['data'=> [],
                'success' => false, 'message'=> 'failed', 'description'=>'no data found!', 'code'=>'400'],400);
                
        $address = Address::find($address);
        
        if($address == null)
            return response()->json(['data'=> [],
                'success' => false, 'message'=> 'failed', 'description'=>'address not found!', 'code'=>'400'],400);
        ...
        if(isset($validateData['country_iso_code'])){
            ...
            if ($country === null)
                return response()->json(['data'=> [],
                    'success' => false, 'failed'=> 'success', 'description'=>'country not found, contact support!', 'code'=>'400'],400);
            ...
            if ($currentCity === null)
                return response()->json(['data'=> [],
                    'success' => false, 'failed'=> 'success', 'description'=>'city not found!', 'code'=>'400'],400);
    ...
    public function verifyDriverOTP(Request $request, $orderId, $otp)
    {
        ...
        if ($customerOtpLog != null  && $customerOtpLog->disabled == false && $otp == $customerOtpLog->mobile_verification_code) {
            ...
            return response()->json(['message' => 'verified success.',
                'data' => null, 'description' => '', 'code' => '200', 'success' => true], 200);
        }else{
            return response()->json(['message' => 'wrong otp/not exists!',
                'data' => null, 'description' => '', 'code' => '400', 'success' => false], 400);
        }
    }
